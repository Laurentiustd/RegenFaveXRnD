        ...
        <div class="container py-5 h-100">
            <div class="col">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <label class="form-label" for="name" :value="__('Name')">Full Name
                                            *</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="email" style="background-color: #F8F4F2" id="email"
                                            name="email" :value="old('email')" required autocomplete="username"
                                            class="form-control " placeholder="abcde@gmail.com" />
                                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" style="background-color: #F8F4F2" id="number"
                                            class="form-control" name="number" placeholder="+62 | " />
                                        @error('number')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <label class="form-label" for="password" :value="__('Password')">Password
                                            *</label>
                                        <input type="password" style="background-color: #F8F4F2" id="password"
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="password" style="background-color: #F8F4F2"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" style="background-color: #F8F4F2" id="username"
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <select class="form-select" style="background-color: #F8F4F2" id="gender"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="date" style="background-color: #F8F4F2" id="birthdate"
                                            name="birthdate" class="form-control" placeholder="DD/MM/YYYY" />
                                        @error('birthdate')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" style="background-color: #F8F4F2" id="city"
                ...
                <div class="d-flex justify-content-between">
                    <button type="button" class="text-muted border-0 bg-transparent" data-mdb-ripple-color="dark"><a
                            href="/login" style="text-decoration: none; color: inherit"><small>
                                < Back To Login</small></a></button>
                </div>
            </div>
        </div>
    </section>
