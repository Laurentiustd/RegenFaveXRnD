    ...
    <style>
        ...
        *{font-family: 'Montserrat';}
          body {
            ...
            background-color: #F8F4F2; /* Light cream color */
             display: flex;
...
#brand{font-family: 'PT Serif Caption';}
#loginbtn{border-color: #4A4E69;
  border-width: 3px;
}

#signupbtn{color: #F8F4F2;
  background-color: #22223B;
}

#savebtn{color: #F8F4F2;
    background-color: #22223B;
}
...
#input{
    ...
    border-color:#22223B;
        ...
        textarea {
            min-height: 220px; /* Height based on thumbnail and title */
            resize: vertical;
        }
    </style>
</head>
        ...
        <div class="left-container">
            <div class="form-group">
                ...
                <div class="article-thumbnail-container" onclick="document.getElementById('thumbnail').click()">
                    ...
                    <input type="file" id="thumbnail" onchange="loadThumbnail(event)">
                </div>
            </div>
            <div class="form-group">
