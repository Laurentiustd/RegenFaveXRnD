            ...
            <div class="left-container">
                <div class="form-group">
                    ...
                    <div class="article-thumbnail-container" onclick="document.getElementById('thumbnail').click()">
                        ...
                        <input type="file" id="thumbnail" name="Image" value="{{$article->Image}}" onchange="loadThumbnail(event)">
                    </div>
                </div>
                <div class="form-group">
                    <label for="title">Article
                        Title:</label>
                    <input type="text" id="title" name="Tittle" value="{{$article->Tittle}}">
                </div>
            </div>
            <div class="right-container">
                <div class="form-group">
                    <label for="content">Article Content:</label>
                    <textarea id="content" rows="5" name="Content">{{$article->Content}}</textarea>
                </div>
                <div id="articles">
                </div>
                <button id="save"
